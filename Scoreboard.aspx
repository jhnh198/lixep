...
<asp:Content ID="Content3" ContentPlaceHolderID="cntPageMain" runat="server">
    ...
    <asp:Panel runat="server"
        ...
        <asp:Button ID="btnPrevious" runat="server" Text="<--" OnClick="Button2_Click1" style="margin-left: 0px" />
        ...
        <asp:Button ID="btnNext" runat="server" Text="-->" OnClick="Button1_Click1" style="margin-left: 0px" />
