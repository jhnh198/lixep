...
<asp:Content ID="Content3" ContentPlaceHolderID="cntPageMain" runat="server">
    ...
    <asp:Image ID="Image1" runat="server" Height="383px" Width="600px" ImageUrl="~/Images/Screenshot (12).png" BorderColor="Gray" BorderStyle="Solid" BorderWidth="15px" ImageAlign="Top" />
    <asp:Image ID="Image2" runat="server" Height="1" Width="1" ImageUrl="~/Images/Screenshot (16).png" Visible="false" />
    ...
    <asp:Image ID="Image5" runat="server" Height="1" Width="1" ImageUrl="~/Images/Screenshot (15).png" Visible="false" />
